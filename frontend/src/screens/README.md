...
- 노브: `BLEMIDI_2`의 `커스텀 GATT 3바이트 T/B/V(각 0~100)`을 순서대로 High/Mid/Low로 해석하여 왼쪽 도트 3개에 각각 반영합니다. 한 모듈의 세 채널을 가정합니다. 화면의 각 도트 영역을 가로로 조작하거나 키보드로 값을 바꿀 수도 있습니다.
...
재생/일시정지, 탐색, 반복, 선택 앨범 전환을 제공합니다. Finish는 Home으로 돌아갑니다.
